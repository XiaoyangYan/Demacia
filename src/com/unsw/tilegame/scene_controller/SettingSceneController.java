...
import com.unsw.tilegame.view.DesignModeScreen;
...
public class SettingSceneController {
	...
	public void handleMousePressDesign(Game game,Stage stage) {
		stage.setScene(new DesignModeScreen(game,stage).getScene());
	}
}
